...
function wpdocs_theme_setup() {
    add_image_size( 'detalhe-post', 680, 580, true ); // (cropped)
    add_image_size( 'mini-post', 190, 150, true ); // (cropped)
    add_image_size( 'list-coluna', 280, 280, true ); // (cropped)
...
function change_post_label() {
    ...
    global $submenu;
    $menu[5][0] = 'Artigos';
    $submenu['edit.php'][5][0] = 'Todos os post';
